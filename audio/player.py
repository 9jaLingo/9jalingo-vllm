"""Audio player for 9jaLingo TTS — decodes LLM-generated speech tokens via NeMo codec"""
...
class NaijaLingoAudioPlayer:
    """Handles audio codec decoding for 9jaLingo TTS token streams."""
